<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        try {
            ...
            $categoria = Wishlist::updateProductoWishlist($mysqli, $nombreWishlist, $descripcionWishlist, $blobImagenWishlist, $nombreImagenWishlist, $tipoImagenWishlist, $privacidadWishlist);
