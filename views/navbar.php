            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <form class="d-flex w-100" role="search">
                    <div class="input-group input-group-md rounded-pill">
                        <input class="form-control border-0 text-secondary" type="search" placeholder="Buscar producto..." aria-label="Search" aria-label="Search" aria-describedby="button-addon2">
                        <a class="input-group-text btn-primario" id="button-addon2" href="search.php"><i class="bi bi-search"></i></a>
                    </div>
                </form>
                <li class="nav-item">
                    <a href="chat.php" class="nav-link btn btn-light w-100 d-flex justify-content-between align-items-center" role="button">
                        <div class="d-md-none">Mensajes</div>  
                        <i class="bi bi-chat-left color-primario"></i>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="cart.php" class="nav-link btn btn-light w-100 d-flex justify-content-between align-items-center" role="button">
                        <div class="d-md-none">Carrito de compras</div>  
                        <i class="bi bi-bag color-primario"></i>
                    </a>
                </li>

                <li class="nav-item dropstart d-none d-lg-block">
                    <a class="nav-link dropdown btn btn-light w-100 d-flex justify-content-between align-items-center" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
