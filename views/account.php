...
<body>
    ...
    <div class="contenedor-informacion-perfil bg-blanco py-5">
        <div class="container">
            <div class="d-flex align-items-center gap-4">
                <form action="">
                    <div class="foto-perfil rounded-circle"></div>
                    <div class="position-relative">
                        <div class="position-absolute boton-editar-foto">
                            <label for="foto-perfil" class="btn btn-primario rounded-circle"><i class="bi bi-pencil-fill"></i></label>
                ...
                <div class="">
                    ...
                    <h5 class="text-secondary m-0">Comprador</h5>
                </div>
            </div>
        </div>
    </div>
    <main class="container py-4">
        <form action="#" id="formSignup" method="post">
            ...
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-secundario">Guardar cambios</button>
            </div>
        </form>
    </main>
